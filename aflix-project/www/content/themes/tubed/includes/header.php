    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="navbar-header col-md-8 col-sm-12">
                ...
                <div class="col-md-4 hello" style="margin-top:20px; color:white;"><a href="/show" style="color:#fff;">SHOWS</a> |<a href="/livevideo" style="color:#fff;"> LIVE</a></div>
                <div class="col-md-4">
            ...
            <a href="" data-toggle="modal" data-target="#register" style="color: #fff; font-weight: normal; text-decoration: none; font-size: 14px;">Contribute</a></span>
                    <?php }elseif(@Auth::user()->contribute_req =='0' OR @Auth::user()->contribute_req_status =='0'){ ?> <a href="#" data-toggle="modal" data-target="#myModal" style="color: #fff; font-weight: normal; text-decoration: none; font-size: 14px;">Contribute</a> <?php }else{ ?><a href="/addvideos" style="color: #fff; font-weight: normal; text-decoration: none; font-size: 14px;">Contribute </a><?php } ?></div>
