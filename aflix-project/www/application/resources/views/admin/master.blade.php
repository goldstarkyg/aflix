...
<head>
	...
	<link rel="stylesheet" href="{{ '/application/assets/admin/css/dataTables.min.css' }}">
	...
	<script src="{{ '/application/assets/admin/js/dataTables.min.js' }}"></script>
	...
	<div class="sidebar-menu page-right-in">
		...
		<div class="sidebar-menu-inner">
			...
			<ul id="main-menu" class="main-menu">
		        ...
		        <li>
		            ...
		            <ul>
						...
						?>
			             <li>
			                <a href="{{ URL::to('admin/viewershipdashboard') }}">
				...
				<li class="">
					...
					<ul>
						...
						<!--<li>
							<a href="{{ URL::to('admin/videos/index1') }}">
								<span class="title">All Videos</span>
							</a>
						</li>-->
						...
						<!--<li>
							<a href="{{ URL::to('admin/videos/create1') }}">
								<span class="title">Add New Video</span>
							</a>
						</li>-->
						...
						<li>
							<a href="{{ URL::to('admin/videos/index3') }}">
								<span class="title">Add Ads</span>
							</a>
						</li>
						<li>
							<a href="{{ URL::to('admin/users/index4') }}">
								<span class="title">Assign Video List</span>
							</a>
						</li>
						<li>
							<a href="{{ URL::to('admin/videos/index6') }}">
				...
				<li class="">
					...
					<ul>
						...
						<li>
							<a href="{{ URL::to('admin/videos/index5') }}">
								<span class="title">Assign Videos</span>
							</a>
						</li>
					</ul>
				</li>
			...
			<!--<li class="">
					...
					<ul>
						<li>
							<a href="{{ URL::to('admin/content/create1') }}">
				...
				<li class="">
					...
					<ul>
						...
						<li>
							<a href="{{ URL::to('admin/Subscribe/create') }}">
				...
				<li class="">
					<a href="{{ URL::to('admin/manage/manage') }}">
				...
				<li class="">
					...
					<?php @$p=Auth::user()->username;
						...
						?>
						<li>
							<a href="{{ URL::to('admin/users/index1') }}">
								<span class="title">All Users</span>
							</a>
						</li>
						<?php
						...
						<li>
							<a href="{{ URL::to('admin/user/create1') }}">
						...
						?>
						<li>
							<a href="{{ URL::to('admin/user/create2') }}">
								<span class="title">Add Corporate User</span>
							</a>
						</li>
						<li>
							<a href="{{ URL::to('admin/user/upload') }}">
						...
						?>
						<li>
							<a href="{{ URL::to('admin/user/contributor_req') }}">
			...
			<!--<li class="">
				...
				?>
					...
					<li class="">
						...
						<ul>
						    <li class="">
								<a href="{{ URL::to('admin/trackrevenue') }}">
									<span class="title">Revenue Tracking</span>
								</a>
							</li>
							<li class="">
								<a href="{{ URL::to('admin/payment/index1') }}">
									<span class="title">Manage Payment For Premium Video</span>
								</a>
							</li>
							<li class="">
								<a href="{{ URL::to('admin/payment/contributorpay') }}">
									<span class="title">Manage Payment For Subscribe Video</span>
								</a>
							</li>
                            <li class="">
								<a href="{{ URL::to('admin/payment/managecontributorpayment') }}">
				...
				if(Auth::user()->role == 'registered' && Auth::user()->contribute == 'contribute'){?>
					<li class="">
						...
						<ul>
							<li class="">
								<a href="{{ URL::to('admin/checkrevenue') }}">
									<span class="title">Check Revenue</span>
								</a>
							</li>
						</ul>
					</li>
				...
				<li class="">
					...
					<ul>
						...
						<li class="">
							<a href="{{ URL::to('admin/videos/banner') }}">
