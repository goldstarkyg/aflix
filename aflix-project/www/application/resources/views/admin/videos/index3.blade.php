...
// save the embed code to your database to display the video in the future
		...
		<input type="hidden"  class="form-control" name="link" id="a">
			...
			<tr>
				...
				<td>
					<p class="actions">
						...
						<a href="/admin/videos/ad/edit/{{ $code->id }}"  data-toggle="modal" data-target="#<?php echo $code->id?>" class="edit btn btn-xs btn-info"><span class="fa fa-edit"></span> Edit</a>
