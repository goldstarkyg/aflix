...
class AdminController extends Controller {
	...
	public function viwershipDashboard(Request $request)
	{
       ...
       /* $videoview = new VideoView();
		...
		return view('admin.dashboard.viwership', compact('month', 'contributor', 'results', 'free_registered_users', 'monthly_paid_subscribed_users', 'yearly_paid_subscribed_users'));
	}
	...
	public function trackRevenue(Request $request)
	{
		...
		$video = new Video();
		$results   = $video->getPerVideoRevenueData(date("m", strtotime($date)), $contributor);
